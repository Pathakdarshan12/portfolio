      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <header className="text-center max-w-4xl mx-auto mb-24">
          ...
          <p className="text-lg lg:text-xl text-slate-500 dark:text-slate-400 font-medium leading-relaxed max-w-2xl mx-auto">
            Detailed dissections of technical strategy, distributed system
            design, and the high-impact results delivered through data
            architecture.
          </p>
        </header>
          ...
          {CASE_STUDIES.length > 0 ? (
            CASE_STUDIES.map((study, i) => (
              ...
              >
                ...
                <div className="lg:col-span-4 min-h-[300px] bg-slate-100 dark:bg-slate-800/80 flex items-center justify-center p-12 relative overflow-hidden">
                  ...
                  <BookOpen
                    size={100}
                    className="text-primary-500 opacity-20 group-hover:scale-110 group-hover:rotate-6 transition-all duration-700 relative z-10"
                  />
                ...
                <div className="lg:col-span-8 p-10 lg:p-16 flex flex-col justify-center">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                      Case Narrative •{" "}
                      {(study.techStack || study.technologies || []).length}{" "}
                      Technologies
                    </span>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2.5 mb-12">
                    {(study.techStack || study.technologies || []).map((t) => (
                      <span
                        key={t}
                        className="px-4 py-2 bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl text-xs font-bold text-slate-500 dark:text-slate-300"
                      >
                        {t}
                      </span>
                    ))}
            ...
            <div className="py-32 text-center bg-white dark:bg-slate-900/40 rounded-[3rem] border-2 border-dashed border-slate-200 dark:border-slate-800">
              ...
              <p className="text-slate-500 max-w-md mx-auto mb-10 font-medium">
                Our detailed technical narratives are currently undergoing final
                documentation review. Check back shortly for deep architectural
                dives.
              </p>
              <Link
                to="/"
