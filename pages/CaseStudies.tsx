          ...
          {CASE_STUDIES.length > 0 ? (
            CASE_STUDIES.map((study, i) => (
              ...
              >
                ...
                <div className="lg:col-span-4 min-h-[300px] relative overflow-hidden bg-slate-100 dark:bg-slate-800">
                  <img
                    src={study.image}
                    alt=""
                    className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
                  />
                  <div className="absolute inset-0 bg-gradient-to-r from-primary-900/40 to-transparent group-hover:from-primary-900/20 transition-all"></div>
                </div>
                ...
                <div className="lg:col-span-8 p-10 lg:p-16 flex flex-col justify-center">
                  <div className="flex items-center gap-4 mb-6">
                    {study.domains.map(d => (
                      <span key={d} className="px-4 py-1.5 bg-primary-500 text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary-500/20">
                        {d}
                      </span>
                    ))}
