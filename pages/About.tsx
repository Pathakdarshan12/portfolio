      ...
      <div className="flex-grow flex flex-col p-8 lg:p-12 rounded-[2.4rem] bg-white/95 dark:bg-slate-950/80 backdrop-blur-3xl border border-white/10 dark:border-white/5 text-slate-900 dark:text-white relative z-10">
        ...
        <div className="flex justify-between items-start mb-10">
          <div className="relative">
            <div
              className={`absolute inset-0 bg-gradient-to-br ${gradient} blur-2xl rounded-full scale-150 opacity-0 group-hover:opacity-30 transition-opacity duration-500`}
            ></div>
            <div
        ...
        <div className="space-y-4 mb-12 flex-grow">
          <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-white/30 mb-5">
            Core Competencies
          </h4>
          <div className="grid grid-cols-1 gap-3.5">
            {competencies.map((item: any, i: number) => (
              ...
              >
                ...
                <span className="text-sm font-bold tracking-tight text-slate-700 dark:text-white/90">
                  {item.text}
                </span>
              </motion.div>
            ))}
        ...
        {/* Tech Ecosystem */}
        <div>
          <h4 className="text-[11px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-white/30 mb-6">
            Tech Ecosystem
          </h4>
    ...
    <div className="bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <section className="relative min-h-[90vh] flex items-center overflow-hidden py-20">
        ...
        <div className="absolute inset-0 -z-10">
          ...
          <div
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full opacity-[0.03] dark:opacity-[0.05]"
            style={{
            ...
            <div className="lg:col-span-7 space-y-8">
              <div>
                ...
                <h1 className="text-5xl sm:text-7xl font-extrabold tracking-tight mb-4">
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary-500 via-purple-500 to-blue-500">
                    Data Story
                  </span>
                </h1>
              ...
              <div className="flex flex-wrap gap-4">
                <Link
                  to="/projects"
                  className="px-8 py-4 bg-primary-500 hover:bg-primary-600 text-white rounded-2xl font-bold transition-all shadow-lg shadow-primary-500/20 flex items-center group"
                >
                  View Projects{" "}
                  <ArrowRight
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-12 relative z-20">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 p-8 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border border-slate-200 dark:border-slate-800 rounded-[2.5rem] shadow-xl shadow-slate-200/50 dark:shadow-none">
          {[
            ...
            <div
              key={i}
              className="flex items-center space-x-4 p-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-800 transition-colors group"
            >
            ...
            {lifecycleStages.map((stage, i) => (
              <div
                ...
                className={`relative p-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] transition-all duration-500 cursor-default group ${
                  activeStage === i
                    ? "shadow-2xl shadow-primary-500/10 -translate-y-2 border-primary-500/50 scale-105"
                    : "hover:border-primary-500/20"
                }`}
              >
                <div
                  className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${stage.color} text-white flex items-center justify-center mb-6 shadow-lg shadow-primary-500/20 group-hover:scale-110 transition-transform`}
                >
                  <stage.icon size={28} />
                </div>
                  ...
                  <div className="p-10 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] shadow-sm hover:shadow-xl transition-all">
                    ...
                    <div className="flex flex-wrap gap-2 mb-8">
                      {job.tech.map((t) => (
                        <span
                          key={t}
                          className="px-3 py-1 bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 rounded-lg text-xs font-bold"
                        >
                          {t}
                        </span>
                      ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {BLOG_POSTS.slice(0, 2).map((post) => (
            <Link
              key={post.id}
              to={`/blog/${post.slug}`}
              className="group p-8 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] hover:shadow-2xl transition-all flex flex-col md:flex-row gap-8"
            >
              ...
              <div className="flex-1">
                ...
                <h4 className="text-2xl font-bold mb-4 group-hover:text-primary-500 transition-colors leading-tight">
                  {post.title}
                </h4>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="rounded-[3rem] overflow-hidden shadow-2xl relative aspect-square">
            <img
              src="https://picsum.photos/seed/hike/1000/1000"
              alt="Personal Side"
              className="w-full h-full object-cover"
            />
          ...
          <div className="space-y-8">
            <h2 className="text-sm font-bold uppercase tracking-[0.3em] text-primary-500">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
              I approach engineering with curiosity and discipline. Outside of
              my core work, I spend time strengthening fundamentals, learning
              from real-world systems, and building side projects that deepen my
              understanding of data, quality, and analytics engineering.
            </p>
              ...
              {[
                {
                  ...
                  desc: "Data engineering and analytics concepts",
                },
                {
                  icon: PenTool,
                  title: "Technical Writing",
                  desc: "Documenting learnings through blogs",
                },
                {
                  icon: Code2,
                  title: "Side Projects",
                  desc: "Hands-on experimentation with data tools",
                },
                {
                  icon: Brain,
                  title: "Problem Solving",
                  desc: "Breaking down complex data challenges",
                },
              ].map((h, i) => (
      ...
      <section className="bg-slate-950 text-white py-32 relative overflow-hidden">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-16">
            <a
              href="mailto:pathak12darshan@gmail.com"
              className="p-6 bg-white/5 border border-white/10 rounded-3xl hover:bg-primary-500 transition-all"
            >
              <Mail size={32} />
            </a>
            <a
              href="https://linkedin.com/in/pathakdarshan12"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 bg-white/5 border border-white/10 rounded-3xl hover:bg-blue-600 transition-all"
            >
              <Linkedin size={32} />
            </a>
            <a
              href="https://github.com/Pathakdarshan12"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 bg-white/5 border border-white/10 rounded-3xl hover:bg-slate-800 transition-all"
            >
              <Github size={32} />
            </a>
            <a
              href="https://leetcode.com/pathakdarshan12"
              target="_blank"
              rel="noopener noreferrer"
              className="p-6 bg-white/5 border border-white/10 rounded-3xl hover:bg-orange-600 transition-all"
            >
              <Code size={32} />
            </a>
          </div>
          <Link
            to="/connect"
            className="text-primary-400 font-bold text-lg hover:underline underline-offset-8"
          >
